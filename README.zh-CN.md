...
- Searcher / Calibration 的实验性 FRLG 野生携带物预测（火红英文版甜甜香气实测档案）
...
- 野生搜索中可显式启用 **火红英文版甜甜香气携带物档案（实验）**；结果表会显示源码携带率、实测基准 Offset、携带物 roll，以及可能的异步 `+1` 轨迹
- 携带物精确筛选只在已有稳定实机基准的地点启用；宝可梦塔 7F 等已确认双轨迹的地点只展示两条候选，不做精确筛选
